...
const JobApplicationModal = ({ jobs, onClose }: { jobs: typeof mockJobs; onClose: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 p-4">
      <div className="bg-white rounded-lg p-8 w-full max-w-lg relative text-black">
        {state.success ? (
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6 text-sm">Our team will review your application and get in touch if your profile matches our requirements.</p>
          ...
          <>
            ...
            <h2 className="text-3xl font-bold font-heading mb-6 text-center text-[#17134d]">Apply Now</h2>
            <form ref={formRef} action={formAction} className="space-y-4">
               <input type="hidden" name="phone" value={`${countryCode} ${phone}`} />
               <div>
                <label className="block text-gray-700 font-semibold mb-2">Full Name</label>
                <input type="text" name="name" required className="w-full p-2 border border-gray-300 rounded-md bg-white" />
              </div>
              <div>
              ...
              <div>
                ...
                <div className="flex">
                  ...
                  <input type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} required pattern="[0-9]{10}" title="Please enter a 10-digit phone number" placeholder="10-digit phone number" className="w-full p-2 border border-gray-300 rounded-r-md bg-white" />
                </div>
              </div>
              <div>
                <label className="block text-gray-700 font-semibold mb-2">Email</label>
                <input type="email" name="email" required className="w-full p-2 border border-gray-300 rounded-md bg-white" />
              </div>
              <div>
  ...
  return (
    <>
      <main className="bg-white">
        <motion.header 
          className="relative h-96 md:h-[500px] flex items-center text-white overflow-hidden"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <div className="relative z-20 max-w-7xl mx-auto w-full px-6 flex justify-start">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold font-heading leading-tight text-white" style={{textShadow: '2px 2px 8px rgba(0,0,0,0.7)'}}>
                Find Your Next Opportunity
              </h1>
              <p className="mt-4 text-lg md:text-xl text-white" style={{textShadow: '1px 1px 6px rgba(0,0,0,0.7)'}}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 space-y-20">
          ...
          <section className="text-center">
            ...
            >
                <motion.div variants={fadeInUpItem} className="bg-slate-50 p-6 rounded-lg border-l-4 border-blue-600 shadow-md">
                    <h3 className="text-xl font-bold font-heading mb-2 text-[#17134d]">Verified Openings</h3>
                    <p className="text-black">Every job is verified and comes directly from trusted employers.</p>
                </motion.div>
                <motion.div variants={fadeInUpItem} className="bg-slate-50 p-6 rounded-lg border-l-4 border-blue-600 shadow-md">
                    <h3 className="text-xl font-bold font-heading mb-2 text-[#17134d]">Diverse Domains</h3>
                    <p className="text-black">Explore roles in IT, Cloud, Software Development, Data, and more.</p>
                </motion.div>
                <motion.div variants={fadeInUpItem} className="bg-slate-50 p-6 rounded-lg border-l-4 border-blue-600 shadow-md">
                    <h3 className="text-xl font-bold font-heading mb-2 text-[#17134d]">Career Growth</h3>
                    <p className="text-black">We match you with opportunities that align with your skills and goals.</p>
                </motion.div>
                <motion.div variants={fadeInUpItem} className="bg-slate-50 p-6 rounded-lg border-l-4 border-blue-600 shadow-md">
                    <h3 className="text-xl font-bold font-heading mb-2 text-[#17134d]">End-to-End Support</h3>
          ...
          <section>
            ...
            >
              {mockJobs.map(job => (
                <motion.div key={job.id} variants={fadeInUpItem} className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-lg transition-shadow">
          ...
          >
              <h2 className="text-3xl md:text-4xl font-bold font-heading mb-12 text-[#17134d]">How It Works</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                  <motion.div variants={howItWorksItem} className="flex flex-col items-center">
                      ...
                      <h3 className="text-xl font-bold font-heading mb-2 text-[#17134d]">Browse Openings</h3>
                  ...
                  <motion.div variants={howItWorksItem} className="flex flex-col items-center">
                      ...
                      <h3 className="text-xl font-bold font-heading mb-2 text-[#17134d]">Apply Easily</h3>
                  ...
                  <motion.div variants={howItWorksItem} className="flex flex-col items-center">
                      ...
                      <h3 className="text-xl font-bold font-heading mb-2 text-[#17134d]">Get Matched</h3>
                  ...
                  <motion.div variants={howItWorksItem} className="flex flex-col items-center">
                      ...
                      <h3 className="text-xl font-bold font-heading mb-2 text-[#17134d]">Start Your Journey</h3>
