...
const approachItems = [
  {
    icon: <Users size={40} className="text-[#17134d]" />,
    title: "Partnership",
  ...
  {
    icon: <Crosshair size={40} className="text-[#17134d]" />,
    title: "Precision",
  ...
  {
    icon: <TrendingUp size={40} className="text-[#17134d]" />,
    title: "Performance",
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p 
            className="text-lg md:text-xl text-gray-800 font-medium mt-4 max-w-3xl mx-auto"
          >
