...
export default function FinalCTASection() {
    return (
        <motion.section 
            // CHANGED: Removed dark mode background class
            className="py-24 mt-16 text-center bg-blue-50 rounded-lg"
        ...
        >
            <div className="max-w-3xl mx-auto px-6">
                <motion.h2 
                    // CHANGED: Removed dark mode text class
                    className="text-4xl md:text-5xl font-bold mb-6 font-heading text-[#17134d]"
